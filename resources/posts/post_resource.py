...
class PostResource(BaseResource):
    ...
    def get_posts(self, userPostID: int, userID: int, postID: int, postThreadID: int, postContent: str, dateOfCreation: str, offset: int, limit: int) -> List[PostRspModel]:
        result = self.data_service.get_posts(userPostID, userID, postID, postThreadID, postContent, dateOfCreation, offset, limit)
        final_result = []
